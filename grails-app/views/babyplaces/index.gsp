...
<html>
	...
	<body>
		<a href="#list-babyplaces" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-babyplaces" class="content scaffold-list" role="main">
